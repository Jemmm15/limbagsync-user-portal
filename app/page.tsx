  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-600 via-blue-500 to-blue-300 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl p-12 w-full max-w-2xl">
        <h1 className="text-4xl font-bold text-gray-900 mb-3">LimbagSync User Portal</h1>
        <p className="text-gray-600 mb-10 text-lg">Please select your portal to continue.</p>
          ...
          {portals.map((portal) => {
            ...
            return (
              <button
                ...
                className={`w-full p-6 rounded-2xl transition-all duration-200 flex items-start gap-5 border-l-4 ${
              ...
              >
                ...
                <div className="text-left">
                  <h3 className="font-bold text-gray-900 text-lg">{portal.title}</h3>
                  <p className="text-gray-600 text-base leading-snug">{portal.description}</p>
                </div>
              </button>
            );
          })}
